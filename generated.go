...
func WimarkRadio_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Wimark_AddVendor(p, 10, a)
}

func WimarkRadio_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func WimarkRadio_Get(p *radius.Packet) (value []byte) {
	value, _ = WimarkRadio_Lookup(p)
	return
}

func WimarkRadio_GetString(p *radius.Packet) (value string) {
	value, _ = WimarkRadio_LookupString(p)
	return
}

func WimarkRadio_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _Wimark_GetsVendor(p, 10) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func WimarkRadio_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _Wimark_GetsVendor(p, 10) {
		i = radius.String(attr)
		if err != nil {
...
func WimarkRadio_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _Wimark_LookupVendor(p, 10)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func WimarkRadio_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _Wimark_LookupVendor(p, 10)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func WimarkRadio_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Wimark_SetVendor(p, 10, a)
}

func WimarkRadio_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func WimarkRadio_Del(p *radius.Packet) {
	_Wimark_DelVendor(p, 10)
}

func WimarkBSSID_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Wimark_AddVendor(p, 11, a)
}

func WimarkBSSID_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func WimarkBSSID_Get(p *radius.Packet) (value []byte) {
	value, _ = WimarkBSSID_Lookup(p)
	return
}

func WimarkBSSID_GetString(p *radius.Packet) (value string) {
	value, _ = WimarkBSSID_LookupString(p)
	return
}

func WimarkBSSID_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _Wimark_GetsVendor(p, 11) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func WimarkBSSID_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _Wimark_GetsVendor(p, 11) {
		i = radius.String(attr)
		if err != nil {
...
func WimarkBSSID_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _Wimark_LookupVendor(p, 11)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func WimarkBSSID_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _Wimark_LookupVendor(p, 11)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func WimarkBSSID_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Wimark_SetVendor(p, 11, a)
}

func WimarkBSSID_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func WimarkBSSID_Del(p *radius.Packet) {
	_Wimark_DelVendor(p, 11)
}

func WimarkSSID_Add(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Wimark_AddVendor(p, 12, a)
}

func WimarkSSID_AddString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func WimarkSSID_Get(p *radius.Packet) (value []byte) {
	value, _ = WimarkSSID_Lookup(p)
	return
}

func WimarkSSID_GetString(p *radius.Packet) (value string) {
	value, _ = WimarkSSID_LookupString(p)
	return
}

func WimarkSSID_Gets(p *radius.Packet) (values [][]byte, err error) {
	var i []byte
	for _, attr := range _Wimark_GetsVendor(p, 12) {
		i = radius.Bytes(attr)
		if err != nil {
			return
		}
...
func WimarkSSID_GetStrings(p *radius.Packet) (values []string, err error) {
	var i string
	for _, attr := range _Wimark_GetsVendor(p, 12) {
		i = radius.String(attr)
		if err != nil {
...
func WimarkSSID_Lookup(p *radius.Packet) (value []byte, err error) {
	a, ok := _Wimark_LookupVendor(p, 12)
	if !ok {
		err = radius.ErrNoAttribute
		return
	}
...
func WimarkSSID_LookupString(p *radius.Packet) (value string, err error) {
	a, ok := _Wimark_LookupVendor(p, 12)
	if !ok {
		err = radius.ErrNoAttribute
		return
...
func WimarkSSID_Set(p *radius.Packet, value []byte) (err error) {
	var a radius.Attribute
	a, err = radius.NewBytes(value)
	if err != nil {
		return
	}
	return _Wimark_SetVendor(p, 12, a)
}

func WimarkSSID_SetString(p *radius.Packet, value string) (err error) {
	var a radius.Attribute
	a, err = radius.NewString(value)
	if err != nil {
		return
...
func WimarkSSID_Del(p *radius.Packet) {
	_Wimark_DelVendor(p, 12)
}
